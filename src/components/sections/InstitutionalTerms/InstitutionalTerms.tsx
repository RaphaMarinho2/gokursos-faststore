      ...
      <div className="institucional-terms">
        ...
        <div className="text-container">
          ...
          <p>
            ...
            variedade de serviços a partir da integração de diversas fontes de
            informação. Os Termos desta declaração serão aplicadas quando do uso
            do conteúdo e serviços do referido site da GoKursos . A GoKursos
          ...
          <p>
            ...
            pessoais, tais como: nome, profissão, telefone fixo/celular, data de
            nascimento, nível de escolaridade endereço de e-mail e quaisquer
            outras que possam aperfeiçoar a navegação;
          </p>
          <p>
          ...
          <p>
            ...
            meio de protocolos de segurança, salvo as de domínio público, quando
            autorizado pelo USUÁRIO ou em circunstâncias previstas nesta
            presente política. Em alguns casos, essa identificação será
            ...
            de suas informações pessoais. A identificação também pode ser pedida
            para que uma determinada transação comercial possa ser efetivada. A
            revelação dos dados do USUÁRIO poderá ainda acontecer devido a
            exigências legais ou por determinação judicial. Podemos também
            revelar suas informações pessoais para quaisquer das empresas que
            componham o GRUPO SER EDUCACIONAL;
          </p>
          <p>
            4. A GoKursos não concede qualquer garantia relacionada à
            disponibilidade, continuidade de funcionamento ou infalibilidade do
            seu endereço eletrônico, nem que os mesmos serão úteis para a
            ...
            outros problemas, erros e ataques e, em particular, não garante que
            terceiros não autorizados não possam acessar e, eventualmente,
          ...
          <p>
            6. A GoKursos garante que as informações armazenadas não serão, sob
          ...
          <p>
            ...
            visitantes que usem a GoKursos serão tratadas em concordância com a
          ...
          <p>
            ...
            limitar e realizar a suspensão ou bloqueios, totais ou parciais, de
            disponibilização e acesso ao conteúdo;
          </p>
          <p>
            10. A GoKursos poderá descontinuar a disponibilidade ou distribuição
            de qualquer conteúdo ou mesmo o endereço eletrônico, a qualquer
            tempo e sem necessidade de prévio aviso;
          </p>
          <p>
            11. Ao utilizar o conteúdo disponibilizado pela GoKursos de qualquer
