...
export type HomePageQueryQuery = { site: { siteMetadata: { title: string | null, description: string | null, titleTemplate: string | null } | null } | null, allContentfulCommonQuestions: { nodes: Array<{ question: string | null, answer: { answer: string | null } | null }> }, allContentfulVideoSection: { nodes: Array<{ buttonText: string | null, buttonUrl: string | null, content: string | null, title: string | null, video: { file: { fileName: string | null, url: string | null } | null } | null }> } };
