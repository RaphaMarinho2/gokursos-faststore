...
export type HomePageQueryQuery = { site: { siteMetadata: { title: string | null, description: string | null, titleTemplate: string | null } | null } | null, allContentfulCommonQuestions: { nodes: Array<{ question: string | null, answer: { answer: string | null } | null }> }, allContentfulVideoSection: { nodes: Array<{ buttonText: string | null, buttonUrl: string | null, content: string | null, title: string | null, video: { file: { fileName: string | null, url: string | null } | null } | null }> }, allContentfulBannerMedium: { nodes: Array<{ link: string | null, imagemBannerMedium: { url: string | null } | null }> }, allContentfulPersons: { nodes: Array<{ name: string | null, curso: string | null, imagem: { url: string | null } | null }> }, allContentfulParceiros: { nodes: Array<{ partnerImage: { url: string | null } | null }> } };
